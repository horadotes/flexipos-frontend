                            ...
                            <MenuButton class="-m-1.5 flex items-center p-1.5">
                                ...
                                <span class="hidden lg:flex lg:items-center">
                                    <span class="ml-4 text-sm font-semibold leading-6 text-gray-900"
                                        aria-hidden="true">{{ firstname }} {{ lastname }}</span>
...
const navigation = reactive([
    { name: 'Dashboard', href: '/employee/dashboard', icon: HomeIcon, current: true },
    { name: 'Products', href: '/employee/products', icon: ShoppingBagIcon, current: false },
    { name: 'Product Category', href: '/employee/product_category', icon: NewspaperIcon, current: false },
